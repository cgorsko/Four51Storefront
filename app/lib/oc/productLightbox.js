...
function productlightbox() {
    ...
    function template() {
        return [
            ...
            '<img ng-if="LineItem.Product.UNSPSC!=\'NOSHADOW\'" ng-src="{{image.url}}" class="product-image-large img-responsive" />',
            '<img ng-if="LineItem.Product.UNSPSC==\'NOSHADOW\'" ng-src="{{image.url}}" class="product-image-large img-responsive" style="box-shadow: rgba(0, 0, 0, 0.0) 0px 4px 8px 0px, rgba(0, 0, 0, 0.0) 0px 6px 20px 0px;"/>',
            '</a>',
